...
model.fit(train_data_x, train_data_y, batch_size=200, epochs=20, verbose=1)
...
with open("extended_cnn_model.json", "w") as json_file:
    json_file.write(json_model)
model.save_weights("extended_cnn_model_weights.h5")
